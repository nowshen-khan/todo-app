      ...
      <div className="flex flex-col min-w-0">
        {editingId === todo.id ? (
          <div className="flex gap-2 items-center">
            ...
            />
            <button onClick={() => saveEdit(todo.id)} className="px-2 py-1 bg-green-600 text-white rounded-md">Save</button>
            <button onClick={cancelEdit} className="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-md">Cancel</button>
          </div>
        ) : (
          <>
